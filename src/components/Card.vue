<template>
  <div class="card_wrapper" id="card_wrapper">
        <div class="cards_container" v-for="card in cardList" :key="card.primaryImageUrl">
                            <!--TEMPLATE-->
                            <div id="products_section">
                                <div class="products_page pg_0">
                                    <div class="product product_horizontal">
                                        <span class="product_code">{{card.code}}</span>
                                        <div class="product_status_tooltip_container">
                                            <span class="product_status" v-if="card.isActive">Наличие</span>
                                            <span class="product_status" v-else>Отсутствует на складе</span>
                                        </div>
                                        <div class="product_photo">
                                            <a href="#" class="url--link product__link">
                                                <img :src="card.primaryImageUrl">
                                            </a>
                                        </div>
                                        ...
                                        <div class="product_units">
                                            <div class="unit--wrapper">
                                                <div class="unit--select" :class="bySquareMetre ?  'unit--active' : ''" @click="bySquareMetre = true">
                                                    <p class="ng-binding">За м. кв.</p>
                                                </div>
                                                <div class="unit--select" :class="!bySquareMetre ?  'unit--active' : ''" @click="bySquareMetre = false">
                                        ...
                                        <p class="product_price_club_card">
                                            ...
                                            <span class="goldPrice">{{bySquareMetre ? card.priceGold*card.unitRatio : Math.round(card.priceGoldAlt*100*card.unitRatio)/100 }}</span>
                                            <span class="rouble__i black__i">
                                                <svg version="1.0" id="rouble__b" xmlns="http://www.w3.org/2000/svg" x="0"
                                                    y="0" width="30px" height="22px" viewBox="0 0 50 50"
                                        ...
                                        <p class="product_price_default">
                                            <span class="retailPrice">{{bySquareMetre ? card.priceRetail*card.unitRatio : Math.round(card.priceRetailAlt*100*card.unitRatio)/100 }}</span>
                                            <span class="rouble__i black__i">
                                                <svg version="1.0" id="rouble__g" xmlns="http://www.w3.org/2000/svg" x="0"
                                                    y="0" width="30px" height="22px" viewBox="0 0 50 50"
                                                    enable-background="new 0 0 50 50" xml:space="preserve">
                                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                            ...
                                            <div class="unit--info">
                                                ...
                                                <div class="unit--desc-t">
                                                    <p>
                                                        ...
                                                        <span class="unit--infoInn">1 упак. = {{ Math.round(1/card.unitRatioAlt*100)/100 }} м. кв. </span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product__wrapper">
                                            <div class="product_count_wrapper">
                                                <div class="stepper">
                                                    <input class="product__count stepper-input" type="text" v-model="card.unitRatio">
                                                    <span class="stepper-arrow up" @click="card.unitRatio++"></span>
                                                    <span class="stepper-arrow down" @click="card.unitRatio>1 ? card.unitRatio-- : card.unitRatio"></span>
                                                </div>
                                            </div>
                                            <span class="btn btn_cart" data-url="/cart/"
                                                ...
                                                <span class="ng-binding" :data-product-id="card.productId">В корзину</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
    ...
    async created() {
        ...
        if (response.ok) {
            ...
            this.cardList.forEach((item) => {
                let arr = item.primaryImageUrl.split('')
                let splicedIndex = arr.length - 4
                arr.splice(splicedIndex, 0, "_220x220_1")
                let newString = arr.join('')
                item.primaryImageUrl = newString
            })
...
a.like_text, a.like_text:hover, a.pseudo_link {
...
.user_page_content .section_title, .user_page_content h1 {
    padding-right: 170px;
}
.likeh2, h2 {
...
.clearfix, .grid, .modal_cart_info {
    *zoom: 1;
}
.clearfix:after, .clearfix:before, .grid:after, .grid:before, .modal_cart_info:before {
    display: table;
    line-height: 0;
    content: ""}
...
.categories_list, .inline_block_parent, .pagination_links, .row_container {
    font-size: 0;
    line-height: 0;
    letter-spacing: -1px;
}
...
.categories_list_item, .inline_block, .pagination_item, .row_container .row_item {
    font-size: 14px;
    line-height: normal;
...
.categories_list_item, .order_container, .product_full_gallery_previews img, .with_border {
    border: 1px solid #ccc;
}
.video_container_inner, .with_boxshadow {
...
.auth_enter, .auth_register {
    color: #fc3;
    text-decoration: none;
    border-bottom: 1px dotted #fc3;
    line-height: 46px;
}
.auth_enter:hover, .auth_register:hover {
    color: #fff;
    border: none;
}
.auth_user_link {
...
.text_content>p:not(.section_title) {
    font-size: 16px;
    line-height: 24px;
    margin-bottom: 24px;
}
...
.text_content table.small__cell td, .text_content table.small__cell th {
    font-size: 12px!important;
    vertical-align: middle;
}
...
.text_content .returnInfo__item table tbody tr:nth-child(even) td {
...
.text_content .returnInfo__itemTable td, .text_content .returnInfo__itemTable th {
...
.text_content p.separation__text:after, .text_content p.separation__text:before {
    content: '';
    display: block;
    position: absolute;
    width: 20px;
...
.text_content ol li ol li:nth-child(1):before {
    content: 'а.'}
...
.text_content .video_description, .text_content figcaption {
    font-style: italic;
    font-size: 14px;
    color: #666;
    display: block;
...
.text_content table tbody tr:nth-child(even) td {
    background: #f4f4f4;
}
...
@media (min-width:0px) and (max-width:999px) {
    .content_page .text_content .video_container.float_left, .content_page .text_content .video_container.float_right, .content_page .text_content figure.float_left, .content_page .text_content figure.float_right {
    float: none;
...
.spinner>div {
    ...
    border-radius: 100%;
    display: inline-block;
    animation: a 1.7s infinite ease-in-out both;
    margin-right: 5px;
    background: #fc3;
}
...
.top_auth_enter, .top_auth_register {
    color: #fc3;
    text-decoration: none;
    border-bottom: 1px solid rgba(255, 204, 51, .5);
    line-height: 46px;
}
.top_auth_enter:hover, .top_auth_register:hover {
    color: #fff;
    border-bottom-color: transparent;
}
@media (min-width:1000px) and (max-width:1249px) {
...
.head_wrapper .page_header_small_form, .head_wrapper .page_header_small_login, .head_wrapper .short__fixed {
    display: none;
}
...
.head_wrapper.scroll__fixed .request_small_form {
    background: transparent url(../assets/images/templates/el.png) no-repeat -90px 0;
    content: '';
    display: block;
    height: 30px;
    position: absolute;
...
.footer_links_column_store .hover, .footer_links_column_store:hover .active {
    display: none;
}
...
.card_variants li a .hover, .card_variants li a:hover .active {
    display: none;
}
...
.ic {
    ...
    vertical-align: middle;
    position: relative;
    background-image: url(../assets/images/templates/el.png);
...
.ic_compare, .ic_compare_delete, .ic_compare_plus {
    width: 20px;
    height: 20px;
    background: none;
    margin-left: 5px;
...
.compare_plus_bg1, a:hover .compare_plus_plus {
    fill: #fff;
}
...
.compare_delete_bg1, a:hover .compare_delete_delete {
    fill: #fff;
}
...
.btn_orange, .compare_col .btn_cart, .product .btn_cart, .product_full_price .btn_cart {
    background: #f90;
}
.btn_orange:hover, .compare_col .btn_cart:hover, .product .btn_cart:hover, .product_full_price .btn_cart:hover {
    background: #333;
}
.btn_search:hover {
    background: #ffa927;
...
.btn.btn_disabled, .btn.btn_disabled:active, .btn.btn_disabled:hover, .btn[disabled=disabled] {
    background: #ccc;
    cursor: not-allowed;
    color: #fff;
}
...
.checkbox_input:hover, .checkbox_input_small:hover {
    border-color: #999;
}
...
.niceselect:after {
    content: '';
    background: url(../assets/images/templates/el.png) -90px -60px no-repeat;
    width: 30px;
    height: 30px;
    bottom: auto;
    top: -5px;
...
.niceselect.focus, .niceselect.open, .niceselect:hover {
    border-color: #999;
    color: #000;
}
.niceselect.focus:after, .niceselect.open:after, .niceselect:hover:after {
...
.niceselect .sod_option.selected:before {
    background: url(../assets/images/templates/el.png) -270px 0 no-repeat;
    width: 10px;
    height: 10px;
    right: auto;
    left: 10px;
...
.niceselect_big:after {
    content: '';
    background: url(../assets/images/templates/el.png) -256px -15px no-repeat;
    width: 14px;
    height: 6px;
    bottom: auto;
    top: 50%;
...
.niceselect_big.focus, .niceselect_big.open, .niceselect_big:hover {
    border-color: #999;
    color: #000;
}
.niceselect_big.focus:after, .niceselect_big.open:after, .niceselect_big:hover:after {
...
.stepper-arrow {
    background: #fff url(../assets/images/templates/jquery.fs.stepper-arrows.png) no-repeat;
    border: 1px solid #ccc;
    cursor: pointer;
    display: block;
    height: 50%;
...
.tooltip_user .tooltip_content:after, .tooltip_user .tooltip_content:before {
    right: 97px;
}
...
.pagination_item_current a, .pagination_item_current a:hover {
    cursor: default;
    background: #fc3;
    color: #000;
}
.pagination_item_disabled a, .pagination_item_disabled a:hover {
    cursor: default;
    background: #e1e1e1;
}
...
.pagination_item_current span, .pagination_item_current span:hover {
    cursor: default;
    background: #fc3;
    color: #000;
}
.pagination_item_disabled span, .pagination_item_disabled span:hover {
    cursor: default;
    background: #e1e1e1;
}
.pagination_container {
...
.show_all_link:after {
    content: '';
    background: url(../assets/images/templates/el.png) -248px 0 no-repeat;
    width: 6px;
    height: 12px;
    position: absolute;
    top: 50%;
...
.car_label:hover .ic_car, .car_label input:checked+.ic_car {
    fill: #f90;
}
.file_name {
    font-size: 14px;
...
.delivery_form_step_variant_active .calendar_date_choosen {
    color: #000;
}
.calendar_month {
    font-size: 12px;
...
.form_container.show .progress_bar {
    display: block;
    width: 100%;
    height: 95px;
...
.form_container.show.form_login_h {
    max-height: 223px;
}
.form_inner {
    position: relative;
...
.form_inner .textInput:-moz-placeholder, .form_inner .textInput::-moz-placeholder {
    color: #000;
    text-transform: uppercase;
}
...
.form_registration_info .form_column {
    width: 330px;
}
.form_registration_info .form_row {
    margin-bottom: 17px;
}
.form_registration_info label {
    font-size: 14px;
    display: block;
    margin-bottom: 4px;
}
.form_registration_info .textInput {
    color: #666;
}
.form_registration_info .card_status {
    font-size: 16px;
}
.form_registration_info .btn {
    width: 160px;
    margin-top: 7px;
}
.form_registration_info .btn_save {
    float: left;
}
.form_registration_info .btn_cancel {
    float: right;
}
.form_login {
    margin: 0 0 0 254px;
...
.form_login .form_label_checkbox {
    padding-top: 0;
}
...
.form_restore_pass .form_row {
    float: left;
    width: 240px;
    margin-right: 10px;
}
.form_restore_pass .textInput {
    height: 40px;
    line-height: 38px;
}
.form_restore_pass .btn {
    margin-bottom: 10px;
}
.form_restore_pass a {
    color: #fff;
}
.form_restore_pass .restore__error {
    position: absolute;
    bottom: 15px;
    color: #ff3b3b;
}
.form_restore_pass .restore__success {
    position: absolute;
    bottom: 15px;
    color: #fff;
}
...
.form_callback .form_column {
    width: 50%}
.form_callback .form_row {
    float: left;
    width: 240px;
    margin-right: 10px;
    color: #fff;
...
.form_callback .form_row:last-child {
    margin-right: 0;
}
.form_callback .float_right .form_row:last-child {
    margin-bottom: 0;
}
.form_callback .time_to_call {
    color: #999;
}
.form_callback .time_to_call_text {
    position: absolute;
    top: -24px;
    left: 0;
    font-size: 14px;
}
.form_callback .time_to_call .niceselect_big {
    height: 40px;
    line-height: 38px;
    width: 100%}
.form_callback .textInput {
    height: 40px;
    line-height: 38px;
    display: inline-block;
}
.form_callback .textInput_phone {
    width: 210px;
    margin-left: 7px;
}
.form_hint_text {
...
.form_auth_header {
    font: 300 32px/36px Open Sans, Arial, Helvetica, sans-serif;
    margin-bottom: 8px;
}
.form_auth p {
    margin-bottom: 25px;
}
.form_auth .lost_password_link {
    margin: -7px 0 37px;
}
.form_auth .form_row {
    margin-bottom: 14px;
}
.form_auth .form_row label {
    margin-bottom: 6px;
    display: block;
}
.form_guestbook {
...
.form_guestbook_column {
    float: left;
    width: 330px;
}
.form_guestbook_column:last-child {
    width: 448px;
}
.form_guestbook_column .form_row {
    margin-bottom: 17px;
}
.form_guestbook_column label {
    font-size: 16px;
    display: block;
    margin-bottom: 4px;
}
.form_guestbook_column .textInput_phone {
    width: 304px;
    margin-left: 6px;
}
.form_guestbook_column textarea {
    height: 202px;
}
.form_guestbook_column .label_bot {
    padding: 10px 0 0;
}
.form_guestbook_column .btn_send {
    width: 200px;
    margin-top: 5px;
}
.form_complaint .form_row {
    margin-bottom: 17px;
    width: 400px;
}
.form_complaint .form_row.files_row {
    width: 100%}
.form_complaint .form_row.textInput_phone {
    width: 160px;
}
.form_complaint label {
    font-size: 16px;
    display: block;
    margin-bottom: 4px;
}
.form_complaint .file_input_wrapper {
    margin-bottom: 4px;
}
.form_complaint .file_input_wrapper input {
    display: none;
}
@media (min-width:0px) and (max-width:999px) {
    .form_column {
...
.form_registration .btn_reg {
    margin: 0 0 0 -3px;
}
.form_registration .form_title {
    margin-left: 0;
    text-align: center;
}
.form_login {
...
.form_restore_pass .form_hint_text {
    width: 240px;
}
.form_callback {
    margin: 0 0 0 5px;
...
.form_guestbook .form_row_file {
    float: left;
}
.form_guestbook .form_row_send {
    float: right;
    text-align: right;
    margin-top: 0;
}
.form_guestbook .form_row_send .label_bot {
    padding: 0;
}
.form_guestbook .form_row_send .btn_send {
    margin-top: -2px;
}
}@media (min-width:1000px) and (max-width:1249px) {
    .form_registration {
...
.modal_container.modal_container_open {
    position: absolute;
    visibility: visible;
    z-index: 1000;
    opacity: 1;
...
.modal_container .modal_close .ic_close {
    fill: #999;
}
.modal_container .modal_close:hover .ic_close {
    fill: #fc3;
}
...
.modal_container.modal_buy .card_variants {
    margin: 0;
}
.modal_container.modal_buy .form_row {
    margin-bottom: 20px;
}
.modal_container.modal_buy .textInput {
    text-align: center;
}
.modal_container.modal_buy .modal_form {
    margin-bottom: 30px;
}
.modal_container.modal_cart {
    width: 768px;
    border: 1px solid #666;
    box-shadow: 0 2px 10px rgba(0, 0, 0, .3);
    padding: 20px;
}
.modal_container.modal_cart.modal_container_open {
    top: 50px;
    transform: translate(-50%);
}
.modal_container.modal_cart .modal_title {
    font-size: 24px;
    font-weight: 700;
    line-height: 28px;
    padding-right: 130px;
}
.modal_cart_info .product_photo {
    float: left;
    width: 160px;
    height: 160px;
    margin-right: 12px;
}
.modal_cart_info .product_full_info {
    float: left;
    width: 310px;
    margin-right: 12px;
}
.modal_cart_info .product_full_info .product_options {
    margin: 48px 0 20px;
}
.modal_cart_info .product_full_description_name, .modal_cart_info .product_full_description_value, .modal_cart_info .product_full_description p:not(.section_title) {
    font-size: 14px;
}
.modal_cart_info .product_full_price_left {
    text-align: right;
}
.modal_cart_info .product_full_price .product_price_club_card {
    font-size: 30px;
    margin-bottom: 10px;
}
.modal_cart_info .product_full_price .product_price_default {
    font-size: 28px;
    margin: 0;
}
.filters_block {
...
.filters_container_inner_link:before {
    ...
    width: 6px;
    height: 12px;
    background: url(../assets/images/templates/el.png) -248px -13px no-repeat;
}
...
.filter_quantity_container:after, .filter_quantity_container:before {
    content: ' ';
    position: absolute;
    width: 0;
    height: 0;
...
@media (min-width:0px) and (max-width:999px) {
    ...
    .contacts_page .grid, .index_page .grid {
    display: -ms-flexbox;
    display: flex;
...
.column_left_catalog_container_open .column_left_catalog {
    display: block;
    position: static;
}
...
.search_page .column_left, .sub_category_page .column_left {
    float: left;
    width: 240px;
}
...
.column_right_search_query:-moz-placeholder, .column_right_search_query::-moz-placeholder {
    color: #666;
    opacity: 1;
}
...
.column_right_search:before {
    content: '';
    display: block;
    background: url(../assets/images/templates/el.png) -90px 0 no-repeat;
    width: 30px;
    height: 30px;
    position: absolute;
    top: 5px;
...
.row_products_orange .product .btn_cart, .row_products_orange .product .product_count_wrapper {
    bottom: 7px;
}
@media (min-width:0px) and (max-width:999px) {
    .row_products_orange .product:nth-child(3n), .search_page .row_products_orange .product:nth-child(2n) {
    margin-right: 0;
    border-right: none;
    width: 239px;
}
...
.product_yellow .product_old-price, .product_yellow .product_price, .product_yellow .product_price_default {
    color: #fff;
}
.product_code {
    font-size: 12px;
...
.product .product_unit__desc:after, .product .product_unit__desc:before {
    content: '';
    position: absolute;
    bottom: -8px;
...
.product .product_unit__desc .unit--desc-i {
    ...
    height: 15px;
    margin: 8px 10px 0 0;
    background: url(../assets/../assets/images/icons/product/unit--i.png) 50% no-repeat;
...
.solitary__arrow .solitary__border {
    margin-bottom: -1px;
    border-color: #ccc;
    color: #ccc;
    right: -9px;
...
.solitary__arrow .solitary__color {
    border-color: #fff!important;
    right: -8px;
    top: 11px;
...
.products_carousel .owl-controls .owl-buttons div:before {
    content: '';
    display: block;
    background: url(../assets/images/templates/el.png) -281px 0 no-repeat;
    width: 5px;
    height: 13px;
    position: absolute;
    top: 12px;
...
}.address_link.active, .address_link:hover {
    background: #fc3;
}
...
.search_page .product_table_controls {
    padding-left: 24px;
    margin-top: -6px;
}
...
.cart_row_content .cart_present_label .checkbox_input, .cart_row_content .cart_present_label .checkbox_input_small {
    position: absolute;
    top: 5px;
    left: 0;
}
...
.cart_row_content .cart_present_container:after, .cart_row_content .cart_present_container:before {
    left: 160px;
}
.cart_row_content .product_number {
    top: 25px;
...
.cart_row_content .cart_row_col_price_total, .cart_row_content .cart_row_col_weight {
    padding-top: 72px;
}
.cart_row_content .cart_row_col_delete {
    padding-top: 70px;
}
.cart_row_content .cart_row_col_value .stepper-arrow.down, .cart_row_content .cart_row_col_value .stepper-arrow.up {
    border: 1px solid #999;
}
...
.ng-scope .cart_row_right .cart_row_col_price_total, .ng-scope .cart_row_right .cart_row_col_weight {
    padding-top: 72px;
}
...
.form_choose_color .textInput:-moz-placeholder, .form_choose_color .textInput::-moz-placeholder {
    color: #666;
    opacity: 1;
}
...
.cart_total_container .card_table_number, .cart_total_container .card_table_total_points {
    font-size: 18px;
    font-weight: 700;
    color: #f90;
}
...
.product_full_info_points:after, .product_full_info_points:before {
    content: '';
    display: block;
    position: absolute;
    top: 0;
...
.product_full_tech_details_table tr:nth-child(even) td {
    background: #f3f3f3;
}
...
.special_price .rouble__i svg#rouble__g path, .special_price_d .rouble__i svg#rouble__g path {
    fill: #ed1d24;
}
...
.list--unit-desc .unit--desc-i {
    ...
    height: 15px;
    margin: 8px 10px 0 0;
    background: url(../assets/images/icons/product/unit--i.png) 50% no-repeat;
    background-size: cover;
}
...
.product_full_status .product_status_info_header dd, .product_full_status .product_status_info_header dt {
    color: #999;
}
...
.product_full_additionals_inner .show_more_link {
    ...
    .product_full_additionals .niceselect_big, .product_full_additionals .related__linkScrenn {
    display: none;
}
...
.delivery_form_step_content .call_time>li:first-child {
    margin: 0;
    width: 200px;
}
...
.delivery_call-header {
    margin-bottom: 10px;
    font-size: 20px;
}
.delivery_form-comment-wrapper {
    width: 45%;
    float: left;
}
...
.delivery_form_step_list_variant .delivery_form_step_variant, .delivery_form_step_variant_active .delivery_form_step_variant_content {
    display: block;
}
...
.delivery_form_elevator .checkbox_input, .delivery_form_elevator .checkbox_input_small {
    margin-right: 18px;
}
...
.delivery_form_porters .delivery_form_step_label .checkbox_input, .delivery_form_porters .delivery_form_step_label .checkbox_input_small {
    position: absolute;
    top: 0;
    left: 0;
}
.delivery_form_porters_length {
...
.bases_total_info_city {
    float: left;
}
.bases_total_info_phone {
    float: right;
}
.bases_container {
    border: 1px solid #ccc;
...
.bases_container_single {
    height: auto;
}
.bases_container_double {
    height: 197px;
}
.base_one {
    position: relative;
...
.base_one_coordinates .ic_maptag {
    position: absolute;
    top: 0;
    left: -20px;
}
.base_one_tooltip_content {
    display: none;
}
.base_address {
    font-size: 16px;
...
.question_one {
    ...
    max-height: 40px;
    overflow: hidden;
    transition: max-height .25s ease-in-out, background-color .15s ease-in-out;
}
.question_one_header {
    font-size: 16px;
    line-height: 20px;
...
.faq_menu_link_active {
    font-weight: 700;
}
.faq_menu_link_active:before {
    content: '';
    position: absolute;
    top: 3px;
    left: 0;
...
.order_infographic_terminal {
    padding: 30px 0;
    max-width: 740px;
    margin: 0 auto;
}
.order_infographic_terminal p {
    padding: 45px 0 0;
    color: #777;
    text-align: center;
    font-size: 16px;
...
.order_container .add_products_link {
    text-decoration: none;
    position: absolute;
    top: -46px;
    right: 4px;
...
.order_container .add_products_link .ic_plus {
    margin-right: 8px;
}
.order_container .add_products_link:hover {
    color: #f90;
}
...
.order_container_header:first-child {
    margin-top: 0;
}
.order_container_refresh_link {
    font-size: 14px;
    text-decoration: none;
    text-transform: none;
}
.order_container_refresh_link span {
    text-decoration: underline;
}
.order_container_refresh_link:hover span {
    text-decoration: none;
}
.order_container .product_count_wrapper {
    font-size: 20px;
    font-weight: 700;
}
...
.order_container_footer p {
    font-size: 16px;
}
.order_container_footer .total_price {
    font-size: 30px;
    font-weight: 700;
    margin-left: 38px;
}
.order_container .cart_row_header {
    padding: 11px 0;
}
.order_container .cart_row_col_price, .order_container .cart_row_col_quantity, .order_container .cart_row_col_weight {
    width: 150px;
}
.order_container .cart_row_content .cart_row_col_price, .order_container .cart_row_content .cart_row_col_price_total, .order_container .cart_row_content .cart_row_col_weight {
    padding-top: 22px;
}
.order_container .cart_row_content .cart_row_col_quantity {
    padding-top: 14px;
}
.order_container .cart_row_content .product_count_wrapper {
    text-align: center;
}
.order_container .cart_row_content .ic_present {
    margin-top: 8px;
}
.order_section {
...
.order_section p.processing {
    color: #f24e28;
    margin-top: 25px;
}
.order_section .btn_pay {
    width: 220px;
    vertical-align: middle;
}
.order_section:not(:last-of-type) {

}
.order_section .button_wrapper {
    margin-top: 8px;
}
.order_section .button_wrapper span {
    display: inline-block;
    vertical-align: middle;
    color: darkred;
    font-size: 13px;
...
.order_container .cart_row_col_price, .order_container .cart_row_col_quantity {
    width: 120px;
}
.order_container .cart_row_col_weight {
    width: 110px;
}
.order_container .cart_row_col_price_total {
    width: 130px;
}
.order_container .cart_row_content {
    padding-bottom: 6px;
}
.order_container .cart_row_content .cart_row_col_price, .order_container .cart_row_content .cart_row_col_price_total, .order_container .cart_row_content .cart_row_col_weight {
    padding-top: 25px;
...
.order_container .cart_row_content .product_description {
    padding: 0 30px 0 0;
    margin: 0 0 0 -27px;
    position: relative;
}
.order_container .cart_row_content .product_description .ic_present {
    position: absolute;
    bottom: 10px;
    right: -30px;
}
...
.user_page_content .cart_page_controls {
    position: absolute;
    top: -2px;
    right: 0;
}
.user_page_content .order_container {
    margin: 17px 0 30px;
}
.user_page .cart_row_col_product {
    width: 520px;
}
.user_page .cart_row_col_price {
    width: 100px;
}
.user_page .cart_row_col_quantity {
    width: 130px;
}
.user_page .cart_row_col_weight {
    width: 100px;
}
.user_page .cart_row_col_price_total {
    width: 130px;
}
@media (min-width:0px) and (max-width:999px) {
    .user_page .column_left.visible-lg+.column_right {
    width: 100%;
    padding-top: 40px;
}
.user_page .cart_row_col_product {
...
.user_page .cart_row_col_price, .user_page .cart_row_col_price_total, .user_page .cart_row_col_quantity, .user_page .cart_row_col_weight {
    width: 120px;
}
.user_page .product_description {
    position: relative;
}
.user_page .product_description .ic_present {
    position: absolute;
    bottom: 10px;
    right: -30px;
}
...
.customer_profiles_table thead td {
    color: #666;
    border-bottom: 1px solid #ccc;
}
.customer_profiles_table thead td a {
    color: #666;
    text-decoration: none;
}
.customer_profiles_table tbody tr:nth-child(even) td {
    background: #f4f4f4;
}
.customer_profiles_table td {
    padding: 11px 14px 10px 28px;
    font-size: 14px;
    line-height: 20px;
    border-left: 1px solid #ccc;
    vertical-align: top;
...
.customer_profiles_table td:first-child {
    padding-left: 17px;
}
.customer_profiles_col_code {
    width: 115px;
}
.customer_profiles_col_date {
    width: 200px;
}
.customer_profiles_col_name {
    width: 241px;
}
.customer_profiles_col_type {
    width: 209px;
}
.customer_profiles_col_action {
    width: 225px;
}
.customer_profiles_link_delete, .customer_profiles_link_edit {
    display: inline-block;
    margin-right: 4px;
}
.customer_profiles_link_delete .ic, .customer_profiles_link_edit .ic {
    display: none;
}
@media (min-width:0px) and (max-width:999px) {
    .customer_profiles_table {
...
.customer_profiles_table tbody .customer_profiles_col_action {
...
.customer_profiles_link_delete span, .customer_profiles_link_edit span {
    display: none;
}
.customer_profiles_link_delete .ic, .customer_profiles_link_edit .ic {
    display: inline-block;
...
.user_orders_container .cart_page_controls {
    position: absolute;
    top: -45px;
    right: -3px;
}
...
.user_orders_search_text {
    float: left;
    font-size: 16px;
    line-height: 21px;
    margin-right: 30px;
}
.user_orders_search_dates {
    float: left;
}
.user_orders_search_dates li {
    display: inline-block;
    vertical-align: middle;
    font-size: 16px;
    margin-right: 8px;
}
.user_orders_search_dates li a {
    text-decoration: none;
}
.user_orders_search_dates .textInput {
    margin: 0 4px 0 9px;
    width: 160px;
}
.user_orders_search_controls {
    float: right;
    width: 170px;
}
.user_orders_search_controls .btn {
    margin-bottom: 5px;
}
.user_orders_list {
    margin: 0;
...
.user_order_info_item {
    float: left;
    clear: left;
}
.user_order_info_value {
    float: left;
    font-weight: 700;
    margin: 0 0 0 5px;
}
.user_order_info_value.order_address {
    font-weight: 400;
    max-width: 260px;
}
.user_order_status {
...
.user_order_status_pending {
    color: #ed1c24;
}
.user_order_status_created {
    color: #ccc;
}
.user_order_status_accepted {
    color: #aaa;
}
.user_order_status_process {
    color: #888;
}
.user_order_status_reserved {
    color: #ea8e04;
}
.user_order_status_paid {
    color: #0071d4;
}
.user_order_status_completed {
    color: #093;
}
.user_order .btn {
    position: absolute;
...
.user_estimates_page .user_page_content {
    margin-top: 0;
}
.user_estimates_search {
    padding: 0 0 20px;
}
.user_estimates_search_name {
    float: left;
    width: 490px;
    margin-right: 10px;
}
.user_estimates_search .user_orders_search_dates .textInput {
    width: 110px;
}
.user_estimates_search .user_orders_search_controls {
    width: 140px;
}
@media (min-width:0px) and (max-width:999px) {
    .user_estimates_search_name {
...
.estimates_table thead td {
    border-bottom: 1px solid #ccc;
    font-size: 14px;
    color: #999;
    padding: 14px 0;
}
.estimates_table thead td:first-child {
    padding-left: 38px;
}
.estimates_table tbody tr:first-child td {
    background: none;
}
.estimates_table tbody td {
    padding: 9px 10px;

    font-size: 16px;
    color: #666;
}
.estimates_table tbody td:first-child {
    padding-left: 38px;
}
.estimates_table tbody td .ic {
    display: inline-block;
}
.estimates_table_col_name {
    width: 450px;
}
.estimates_table_col_name a {
    font-weight: 700;
    text-decoration: none;
}
.estimates_table_col_date {
    width: 165px;
    text-align: center;
}
.estimates_table_col_quantity {
    width: 170px;
    text-align: center;
}
.estimates_table_col_download {
    width: 115px;
    padding-left: 16px!important;
}
.estimates_table_col_download a {
    font-size: 14px;
    color: #666;
}
.estimates_table_col_controls a {
    margin-right: 15px;
}
@media (min-width:0px) and (max-width:999px) {
    .estimates_table tbody td:first-child, .estimates_table thead td:first-child {
    padding-left: 20px;
}
.estimates_table_col_name {
    width: 230px;
...
.estimate_container .cart_row_col_quantity {
    width: 155px;
}
.estimate_container .cart_row_col_price_total {
    width: 140px;
}
.estimate_container .order_container_footer {
    padding-right: 10px;
}
.estimate_cart_order {
    text-align: right;
...
.estimate_cart_order a {
    text-decoration: none;
}
.estimate_cart_order a:hover {
    color: #f90;
}
.estimate_cart_order .ic_cart_estimate {
    margin-right: 10px;
}
.estimate_cart_order .btn {
    margin-left: 22px;
    width: 172px;
}
@media (min-width:0px) and (max-width:999px) {
    .estimate_container .cart_row_content .cart_row_col_price {
    padding-top: 72px;
}
.estimate_container .cart_row_content .cart_row_col_quantity {
    padding-top: 65px;
}
.estimate_container .cart_row_content .cart_row_col_price_total, .estimate_container .cart_row_content .cart_row_col_weight {
    padding-top: 72px;
}
.estimate_container .cart_row_content .cart_row_col_delete {
    padding-top: 70px;
}
}@media (min-width:1000px) and (max-width:1249px) {
    .estimate_container {
...
.estimate_container .cart_row_col_product {
    width: 380px;
}
.estimate_container .cart_row_col_price {
    width: 110px;
}
.estimate_container .cart_row_col_quantity {
    width: 90px;
...
.recently_viewed_product_code {
    font-size: 12px;
    color: #666;
    margin: 0 0 7px;
    line-height: 14px;
}
.recently_viewed_product_name {
    float: left;
    width: 360px;
    padding: 9px 0 0;
}
.recently_viewed_product_name p {
    font-size: 16px;
    font-weight: 700;
    line-height: 24px;
    margin: 0;
}
.recently_viewed_product .product_price_default {
    font-size: 24px;
    bottom: auto;
    top: 53px;
    right: 23px;
}
.recently_viewed_product .product_price_club_card {
    font-size: 26px;
    top: 18px;
    right: 14px;
}
.recently_viewed_product .product_price_club_card_text {
    font-size: 12px;
    line-height: 12px;
    color: #666;
}
.recently_viewed_product:hover .recently_viewed_product_name p {
    text-decoration: underline;
}
.ui-autocomplete {
...
.compare_tr_params_price .compare_col_attr, .compare_tr_params_separator .compare_col_attr {
    padding-top: 25px;
}
.compare_col {
    padding: 15px 5px;
...
.collection_one .btn_full_collection {
    width: 240px;
    float: right;
}
.collection_one_inner {
    position: relative;
    height: 400px;
    margin-bottom: 20px;
}
.collection_one .product_price {
    position: static;
    font-size: 22px;
    color: #666;
    font-weight: 400;
}
.collection_one .product_price_club_card {
    position: static;
    font-size: 24px;
    margin-bottom: 8px;
}
.collection_one .product_price_club_card span {
    font-size: 14px;
    font-weight: 400;
}
.collection_name {
...
.collection_dot_link:hover, .collection_dot_link_active {
    border-color: #ed1c24;
}
.collection_content {
    position: absolute;
...
.collection_content .collection_close {
    position: absolute;
    top: 5px;
    left: -80px;
    color: #fff;
...
.collection_product_active .collection_product_link {
    background: #fc3;
...
.collection_content .collection_close:before {
    content: '';
    display: block;
    width: 123px;
    height: 154px;
...
.services__item a, .services__item a:hover {
    transition: .2s linear;
    -webkit-transition: .2s linear;
    -moz-transition: linear .2s;
}
...
}.suggest__wrapper .suggest__example {
    font-size: 15px;
    line-height: 20px;
    padding: 5px 10px;
    cursor: pointer;
...
.suggest__wrapper .suggest__example.suggest__active, .suggest__wrapper .suggest__example:hover {
...
.services__i.i__isDeliveryTo15 {
    background-position: 0 0;
}
.services__i.i__qualityMark {
    background-position: -488px 0;
}
.services__i.i__isDeliveryTo18 {
    background-position: -350px 0;
}
.services__i.i__isSawing {
    background-position: -245px 0;
}
.services__i.i__isDeliveryTo35 {
    background-position: -568px 0;
}
.services__i.i__isDeliveryTo36 {
    background-position: -455px 0;
}
.services__i.i__isDeliveryTo5 {
    background-position: -35px 0;
}
.services__i.i__isManipulator {
    background-position: -70px 0;
}
.services__i.i__isNoLifting {
    background-position: -105px 0;
}
.services__i.i__isNoLiftLifting {
    background-position: -140px 0;
}
.services__i.i__isNoPassengerLift {
    background-position: -385px 0;
}
.services__i.thumbs__up {
    background-position: -490px 0;
}
.services__i.i__coloring2 {
    background-position: -280px 0;
}
.services__i.i__coloring1 {
    background-position: -315px 0;
}
.services__i.i__isUnloadingOnly {
...
.btn.btn_disabled, .pagination_item_disabled {
    pointer-events: none;
    cursor: not-allowed;
}
...
#article_container .news_list li .news_date, #article_container .news_one .news_date {
    color: #9c9c9c;
    font-style: italic;
}
...
.discount__preview .preview__wrapper {
    display: table;
    width: 100%;
    max-width: 596px;
    margin: 20px auto;
}
.discount__preview .preview__wrapper .preview__item {
    float: left;
}
.discount__preview .preview__wrapper .preview__item.middle__tem {
    padding: 0 10%}
.discount__preview .preview__wrapper .preview__item p {
    display: block;
    margin: 0 auto 10px;
    width: 30px;
    height: 30px;
    ...
    -moz-border-radius: 50%;
    -o-border-radius: 50%}
.discount__preview .preview__wrapper .preview__item p span {
    display: block;
    color: #fff;
    font-size: 15px;
    line-height: 20px;
...
.discount__preview .preview__wrapper .preview__item span.item__desc {
    display: block;
    text-align: center;
}
.discount__preview .previewBottom__wrapper {
    width: 100%}
.discount__preview .previewBottom__wrapper p {
    font-size: 13px;
    line-height: 16px;
    margin: 0 0 5px;
}
.discounts__page .legal__info {
    display: table;
    width: 100%;
    margin: 30px 0;
    padding: 10px 20px;
...
.discounts__page .legal__info p {
    font-size: 16px;
    line-height: 30px;
}
.discounts__page .legal__info p:first-child {
    display: block;
    float: left;
    width: 30px;
    height: 30px;
    ...
    -moz-border-radius: 50%;
    -o-border-radius: 50%}
.discounts__page .legal__info p:first-child span {
    display: block;
    color: #fff;
    font-size: 15px;
    line-height: 20px;
...
.discounts__page .club__info {
    display: table;
}
.discounts__page .narrow__item {
    width: 30%;
    float: left;
}
.discounts__page .narrow__item.special__item {
    width: 60%}
.discounts__page .wide__item {
    width: 70%;
    float: left;
}
.discounts__page .wide__item.special__item {
    width: 100%}
.discounts__page .wide__item.special__item .list__info {
    padding: 20px 0 0;
}
.discounts__page .narrow__item img {
    display: block;
    width: 100%;
    margin: auto;
}
.discounts__page .narrow__item img.welcome__img {
    max-width: 180px;
}
.discounts__page .narrow__item img.app__img {
    max-width: 120px;
}
.discounts__page .narrow__item a {
    display: block;
    width: 90%;
    padding: 10px 0;
    margin: 20px auto 0;
...
.discounts__page .narrow__item.special__item p {
    width: 200px;
    float: left;
    margin: 0 20px 0 0;
}
.discounts__page .narrow__item.special__item a {
    width: 200px;
    float: left;
    margin: 5px auto;
}
.discounts__page .wide__item ul.list__info {
    padding: 20px 0;
}
.discounts__page .wide__item ul.list__info li {
    list-style-type: disc;
    font-size: .95em;
    line-height: 1.4em;
    margin-bottom: 10px;
}
.discounts__page .wide__item ul.list__info li a {
    color: #637781;
    transition: .1s linear;
}
.discounts__page .wide__item ul.list__info li a:hover {
    color: #d4a000;
    transition: .1s linear;
}
.discounts__page .narrow__item a:hover {
    transition: .2s linear;
    background: #940206;
}
.discounts__page .club__info .wide__item .subtitle__item {
    font-size: 1em;
    font-weight: 700;
}
.discounts__page .card__info {
    display: table;
    padding: 30px 0 0;
}
.discounts__page .card__info .narrow__item p {
    font-size: 1em;
    font-style: italic;
    padding: 5px 0 0;
    color: #525252;
...
.discounts__page .card__info .wide__item .title__item {
    font-size: 1.4em;
    line-height: 1.6em;
    font-weight: 700;
}
.discounts__page .card__info .wide__item ul li {
    list-style-type: decimal;
}
.discounts__page .card__info .wide__item ul li span {
    color: #676767;
    font-style: italic;
}
.message__error {
...
.input__error {
    ...
    box-shadow: inset 0 0 5px 1px #ed1c24;
    -webkit-box-shadow: inset 0 0 5px 1px #ed1c24;
    -moz-box-shadow: inset 0 0 5px 1px #ed1c24;
    -o-box-shadow: inset 0 0 5px 1px #ed1c24;
}
.address_list_container {
    overflow-y: scroll;
    width: 24%}
...
.ymaps-2-1-34-image, .ymaps-image {
...
.tooltip_base_full:after, .tooltip_base_full:before {
    content: '';
    display: block;
    width: 0;
    height: 0;
...
.page--preloader p {
    ...
    border-left: .4em solid #ff001d;
    transform: translateZ(0);
    animation: b 1s infinite linear;
    z-index: 999;
}
.page--preloader p, .page--preloader p:after {
    border-radius: 50%}
@keyframes b {
    0% {
...
.action_position__fixed.actionNovelty {
    width: 75px;
    height: 35px;
    bottom: 0;
    left: 0;
...
.action_position__fixed.actionBurns {
    width: 75px;
    height: 50px;
    top: 0;
    left: 0;
...
.action_position__fixed.actionProfit {
    width: 75px;
    height: 50px;
    bottom: 0;
    right: 0;
...
.action_position__fixed.actionDouble {
    width: 40px;
    height: 100%;
    top: 0;
    right: 0;
...
.rouble__i svg#rouble__b, .rouble__i svg#rouble__g {
    width: 19px;
    height: 19px;
...
.form_subscribe .textInput, .head_wrapper.scroll__fixed .page_header_small_form .textInput {
    width: 100%}
.product .btn_cart {
    width: 148px;
}
...
.absolute-item .more__title .item_exit, .absolute-item .more__title .item_exit:hover {
    content: '';
    display: block;
    position: absolute;
    top: -9px;
...
.one-item-akcii .you-buy, .one-item-akcii .you-get {
    font-size: 20px;
    text-transform: uppercase;
    line-height: .8;
}
...
.one-item-akcii .you-buy b, .one-item-akcii .you-get b {
    font-size: 35px;
    font-weight: 700;
...
@media only screen and (max-width:1024px) {
    .one-item-akcii .akcii-info.large-info .you-get-desc {
    margin-top: -20px;
}
}.one-item-akcii .how-long-date {
    margin: 0;
    font-size: 15px;
}
.one-item-akcii .how-long:before {
    content: '';
    display: block;
    width: 19px;
    height: 19px;
...
.one-item-akcii .for-hide:before {
    display: none;
}
.one-item-akcii .number {
    margin-bottom: 30px;
}
.one-item-akcii .serial-num {
    font-size: 13px;
    color: #666;
}
.one-item-akcii .main-info-text {
    font-weight: 700;
}
.one-item-akcii .availability {
    text-align: right;
    color: #093;
    font-size: 13px;
    margin-bottom: 30px;
}
.one-item-akcii .avaibility-text {
    border-bottom: 1px dotted;
    cursor: pointer;
}
.one-item-akcii .max-price {
    display: table;
    width: 100%;
    margin-top: 50px;
}
.one-item-akcii .max-price-left {
    width: 45%;
    float: left;
    display: inline-block;
    text-align: right;
}
.one-item-akcii .max-price-right {
    float: right;
    width: 55%;
    display: inline-block;
    font-size: 32px;
...
.one-item-akcii .max-price-text {
    width: 70px;
    font-size: 15px;
    float: right;
}
.one-item-akcii .min-price {
    text-align: right;
    font-size: 29px;
    color: #ccc;
    margin-bottom: 10px;
}
.one-item-akcii .input-basket {
    width: 40px;
    height: 40px;
    display: inline-block;
    border: 1px solid #ccc;
...
.one-item-akcii .basket-buttons {
    width: 25px;
    float: left;
    display: inline-block;
}
.one-item-akcii .basket-button {
    width: 150px;
    height: 40px;
    background-color: #f90;
    float: left;
...
.one-item-akcii .basket-button:hover {
    background-color: #333;
}
.one-item-akcii .button-down, .one-item-akcii .button-up {
    height: 20px;
    border: 1px solid #ccc;
    box-sizing: border-box;
    cursor: pointer;
...
.one-item-akcii .basket-but-box {
    display: table;
    margin-top: 30px;
    width: 97%;
    float: right;
}
.one-item-akcii .in_cart {
    color: #fff;
}
.one-item-akcii .img-cart-box, .one-item-akcii .span-cart-box {
    display: inline-block;
    box-sizing: border-box;
    font-size: 15px;
}
.one-item-akcii .img-cart-box {
    margin-right: 5px;
    position: relative;
    width: 30px;
    height: 40px;
...
.one-item-akcii .img-but {
    position: absolute;
    top: 10px;
    left: 20px;
}
.one-item-akcii .btn_cart {
    background-color: #f90;
    float: right;
    cursor: pointer;
    padding: 0 20px;
}
.one-item-akcii .ic_cart {
    margin-right: 15px;
}
.one-item-akcii .product_count_wrapper {
    position: static;
}
.one-item-akcii .product__wrapper {
    display: table;
    width: 100%;
    margin-top: 35px;
}
.one-item-akcii .btn_cart_already {
...
.one-item-akcii .how-long, .one-item-akcii .how-long-date {
    display: inline-block;
}
.one-item-akcii .for-hide {
    display: none;
}
.one-item-akcii .main-akcii-info {
    height: 240px;
...
.sertificates-catalog .catalog-item {
    border: 1px solid #ccc;
    width: 99%;
    height: 240px;
    padding: 10px;
...
.sertificates-catalog .photo-box {
    float: left;
    display: inline-block;
}
.sertificates-catalog .photo {
    width: 220px;
    height: 220px;
    display: table-cell;
    vertical-align: middle;
}
.sertificates-catalog .info-catalog {
    width: 230px;
    height: 100%;
    display: inline-block;
    float: left;
...
.sertificates-catalog .price_and_cart {
    width: 250px;
    display: inline-block;
    float: right;
    height: 100%}
.sertificates-catalog .serial-code {
    color: #ccc;
    text-align: left;
    margin-bottom: 15px;
}
.sertificates-catalog .main-title-text {
    font-size: 18px;
    font-weight: 700;
}
.sertificates-catalog .available {
    text-align: right;
    color: #093;
    cursor: pointer;
    margin-bottom: 15px;
}
.sertificates-catalog .available-text {
    border-bottom: 1px dotted #093;
}
.sertificates-catalog .available-text:hover {
    border-bottom: none;
}
.sertificates-catalog .card-price {
    display: table;
    width: 100%}
.sertificates-catalog .text-card-price {
    width: 40%;
    display: inline-block;
    float: left;
    text-align: right;
...
.sertificates-catalog .amount-card-price {
    width: 60%;
    display: inline-block;
    float: left;
    text-align: right;
...
.sertificates-catalog .price-amount {
    line-height: .9;
}
.sertificates-catalog .full-price {
    color: #ccc;
    text-align: right;
    font-size: 29px;
}
.sertificates-catalog .column_right .about-serts {
    margin-bottom: 0!important;
}
.sertificates-catalog .input-basket {
    width: 40px;
    height: 40px;
    display: inline-block;
    border: 1px solid #ccc;
...
.sertificates-catalog .basket-buttons {
    width: 25px;
    float: left;
    display: inline-block;
}
.sertificates-catalog .basket-button {
    width: 150px;
    height: 40px;
    background-color: #f90;
    float: left;
...
.sertificates-catalog .basket-button:hover {
    background-color: #333;
}
.sertificates-catalog .button-down, .sertificates-catalog .button-up {
    height: 20px;
    border: 1px solid #ccc;
    box-sizing: border-box;
    cursor: pointer;
...
.sertificates-catalog .akcion-input {
    width: 100%;
    height: 100%;
    box-sizing: border-box;
    text-align: center;
...
.sertificates-catalog .sert-p {
    margin-bottom: 40px!important;
}
.sertificates-catalog .basket-but-box {
    display: table;
    margin-top: 45px;
    width: 97%;
    float: right;
}
.sertificates-catalog .in_cart {
    color: #fff;
}
.sertificates-catalog .img-cart-box, .sertificates-catalog .span-cart-box {
    display: inline-block;
    box-sizing: border-box;
    font-size: 15px;
}
.sertificates-catalog .img-cart-box {
    margin-right: 5px;
    position: relative;
    width: 30px;
    height: 40px;
...
.sertificates-catalog .img-but {
    position: absolute;
    top: 10px;
    left: 20px;
}
.sertificates-catalog .input-left {
    margin-left: 15px;
}
.sertificates-catalog .price .btn_cart, .sertificates-catalog .price .product_count_wrapper {
    bottom: 20px;
}
.side_button_sertificates {
    top: 427px;
}
.card {
    width: 365px;
...
.card .sertificate-info, .enter-name {
    font-size: 16px;
    text-align: center;
}
.card .support-help {
...
.card-popUp-more-info-block .close-card, .card .close-card {
    position: absolute;
    top: 10px;
    right: 10px;
    width: 24px;
...
.card-popUp-more-info-block .close-card:hover, .card .close-card:hover {
    background-size: 100%}
.form__search-exit {
    position: absolute;
    top: 10px;
...
.thanks__continue-buying:hover {
    background-color: #666;
    color: #fff;
}
.thanks__box-need-repair {
    background-color: #ffd351;
    margin-left: calc(-50vw + 50%);
    margin-right: calc(-50vw + 50%);
}
.thanks__main-pic-block {
    display: table;
    margin: 0 auto;
    margin-bottom: 70px;
}
.thanks__inner-pic-block {
    width: 316px;
    display: inline-block;
    float: left;
}
.thanks__inner-img-block {
    height: 150px;
    line-height: 191px;
    text-align: center;
}
.thanks__inner-bold-text {
    text-align: center;
    font-weight: 700;
    font-size: 20px;
    margin-bottom: 5px;
}
.thanks__inner-normal-text {
    font-size: 17px;
    text-align: center;
}
.thanks__choose-master {
    display: table;
    width: 100%;
    line-height: 50px;
    font-size: 18px;
...
.thanks__place-order:hover {
    background-color: #666;
}
.thanks__lk-link {
    text-decoration: none;
    border-bottom: 2px solid #ec571c;
}
.thanks__lk-link:hover {
    border-bottom: none;
}
.thanks__link {
    text-decoration: none;
...
}.burn-subscribe .subscribe-input-text {
    display: block;
    text-align: center;
    font-size: 16px;
    font-weight: 700;
...
.burn-subscribe .subscribe-card-input {
    width: 238px;
    height: 40px;
    border: 1px solid #ccc;
    padding: 5px 10px;
...
.burn-subscribe .subscribe-submit {
    border: none;
    width: 240px;
    background-color: #f90;
    margin-top: 20px;
...
.burn-subscribe .subscribe-submit:hover {
    background-color: #666;
}
.burn-subscribe .subscribe-card-content {
    width: 240px;
    margin: 33px auto;
}
.burn-subscribe .subscribe-card-input-email {
    margin-top: 20px;
}
.burn-subscribe .subscribe-success {
    display: none;
    color: #093;
}
.burn-subscribe .subscribe-error {
    color: #ff2b28;
}
.card-title {
    text-transform: uppercase;
...
.baner-img-big, .baner-img-middle, .baner-img-small {
    display: none;
}
@media (min-width:1250px) {
    .baner-img-big {
...
}.serviceChoose__wrapper .services__menu-picture {
    width: 123px;
    height: 81px;
    margin: 0 auto;
}
.serviceChoose__wrapper .services__link-block {
    display: table;
    width: 197px;
}
.tikurilla__action-details-link {
    text-decoration: none;
}
.tikurilla__action-details {
    text-align: center;
    font-weight: 700;
}
.product__area {
    display: table;
    width: 100%}
.tikurilla__action-text-block {
    text-align: center;
    margin-bottom: 20px;
    margin-top: 35px;
}
.tikkurila__bottom-link {
    color: #000;
    text-decoration: underline;
}
.tikkurila__bottom-link:hover {
    text-decoration: none;
}
...
.login-static .form_label_checkbox {
    width: 60%}
.login-static .form_login {
    margin: 0;
    width: auto;
}
.login-static .form_login .form_row {
    float: none;
    width: 100%;
    border: none;
}
.login-static .form_title {
    text-align: center;
}
.login-static .login__enter {
    width: 300px;
    margin: 0 auto;
}
.login-static .form_title {
...
.login-static .textInput {
    border: none;
    border-bottom: 1px solid #ccc;
    text-align: center;
}
.login-static .form_open_link-login {
    position: absolute;
    bottom: 5px;
    right: 0;
    color: #999;
...
.login-static .btn_orange {
    margin-bottom: 20px;
}
.login-static .messageContainer {
    color: #161616;
    font-size: 18px;
    text-align: center;
    color: red !important;
...
.registration-static-page .float_left, .registration-static-page .float_right {
    float: none;
}
.registration-static-page .form_registration {
    margin: 0;
}
.registration-static-page .form_title {
    color: #161616;
    text-align: center;
}
.registration-static-page .form_column {
    width: 300px;
}
.registration-static-page .form_registration {
    width: 100%}
.registration-static-page .textInput {
    border: none;
    border-bottom: 1px solid #ccc;
    text-align: center;
}
.registration-static-page .btn_orange {
    margin-top: 20px;
}
.forgot-form-static-page {
    margin: 80px auto;
    width: 300px;
}
.forgot-form-static-page .form_restore_pass .form_row {
    float: none;
    margin-bottom: 20px;
    width: 300px;
    margin: 0 auto;
}
.forgot-form-static-page .textInput {
    border: none;
    border-bottom: 1px solid #ccc;
    margin-bottom: 15px;
    text-align: center;
}
.forgot-form-static-page .form_restore_pass {
    margin: 0;
}
.forgot-form-static-page .form_title {
    color: #161616;
    text-align: center;
}
.popup-auth-title-error {
    color: #ed1c24;
}
.popup-auth-title-error, .popup-auth-title-success {
    display: none;
    font-size: 22px;
    text-align: center;
    margin-top: 45px;
}
.popup-auth-title-success {
    color: green;
}
.popup-auth-text {
    font-size: 17px;
...
.form_inner .mainPetrovichLogin_login_error, .form_inner .mainPetrovichLogin_password_error {
    color: #fff;
}
.form_inner .form_open_link-login {
    position: absolute;
    top: 71px;
    right: 393px;
}
.form_inner .form_open_link-forgot {
    position: absolute;
    right: 0;
    bottom: -19px;
}
.static-form .form_open_link-forgot {
    color: #ccc;
    text-decoration: none;
}
.form_inner .mainPetrovichForgot_login_error {
    color: #fff;
    margin-top: 10px;
}
.form_inner .messageContainer {
    color: #fff;
    position: absolute;
    top: 91px;
    left: 254px;
}
.form_inner .messageContainerRegistration {
    color: #fff;
    position: absolute;
    top: 70px;
    left: 254px;
}
.form_inner .auth-error-field {
    color: #fff;
}
.form_inner .messageLoginContainer {
    color: #fff;
    margin-top: 20px;
}
.form_inner .message-container-forgot {
    color: #fff;
    margin-top: 7px;
    width: 320px;
}
.static-form .auth-error-field {
    text-align: center;
    color: red;
    margin-bottom: 10px;
    margin-top: 3px;
...
.static-form-profile .card-status-profile {
    position: absolute;
    top: 70px;
    width: 330px;
    text-align: center;
...
.fast-add-qty .fast-add-qty-input {
    width: 40px;
    border: 1px solid #999;
    height: 40px;
    font-size: 17px;
...
.modal--effect-bottom {
    animation-name: modal--effect-bottom;
}
.modal--effect-left {
    animation-name: modal--effect-left;
}
.modal--effect-right {
    animation-name: modal--effect-right;
}
.modal--effect-bottom--hide {
    animation-name: modal--effect-bottom--hide;
}
.modal--effect-left--hide {
    animation-name: modal--effect-left--hide;
}
.modal--effect-right--hide {
    animation-name: modal--effect-right--hide;
}
...
.fotorama__arr, .fotorama__video-close, .fotorama__video-play {
    background: url(../assets/../assets/images/icons/product/fotorama__i.png) no-repeat;
}
...
to {
    ...
    animation: e 24s infinite linear;
}
...
.fotorama--fullscreen .fotorama__fullscreen-icon {
    ...
    top: 0;
    right: 0;
    background: url(../assets/images/icons/product/fotorama__i.png) no-repeat 0 -32px;
}
...
.product--detail-wrapper input, .product--detail-wrapper p, .product--detail-wrapper span {
    margin: 0;
    box-sizing: inherit;
}
...
.product--detail-info .product--special-info .product--club {
    ...
    width: 190px;
    height: 30px;
    background: url(../assets/../assets/images/icons/product/cloub--i.png) no-repeat;
    float: left;
    margin: 0 0 20px;
}
...
.product--detail-info .product--services-info .product--service-i span {
    display: block;
    background: url(../assets/images/icons/product/services--i.png) no-repeat;
    width: 34px;
    height: 25px;
}
...
.product--detail-info .product--services-info .product--service-i span.i__coloring1 {
...
.product--detail-info .product--services-info .product--service-i span.stock--double {
    background: url(../assets/images/icons/product/services--i.png) -525px 0 no-repeat;
    width: 35px;
}
...
.product--detail-info .product--specification-info .specification--title p {
    font-size: 24px;
    line-height: 26px;
}
...
.product--detail-info .product--specification-info .specification--table table tr:nth-child(even) {
    background: #f3f3f3;
}
...
.product--prices .product--to-cart .to-cart--count span:after {
    ...
    width: 25px;
    height: 19px;
    background: url(../assets/../assets/images/icons/product/count--i.png) no-repeat;
}
...
.product--prices .product--to-cart .to-cart--button .tc--button.btn_cart_already, .product--prices .product--to-cart .to-cart--button .tc--button.btn_cart_already:hover {
    background: #999;
    cursor: default;
}
...
.product--prices .documents--info p.docs--title {
    font-size: 19px;
    line-height: 22px;
    font-weight: 200;
    padding: 5px 0 10px;
...
.product--prices .documents--info .docs--item .docs--preview:before {
    ...
    width: 25px;
    height: 30px;
    background: url(../assets/images/icons/product/print--i.png) -70px 0 no-repeat;
}
...
.product--prices .documents--info .docs--item .helper--area a {
    ...
    width: 30px;
    height: 30px;
    background: url(../assets/images/icons/product/print--i.png) no-repeat;
}
...
.product--detail-related .related--title p {
    font-size: 22px;
    line-height: 26px;
    padding: 0 0 5px;
}
...
.product.related__list .btn_cart, .product.related__list .product_count_wrapper {
    bottom: 10px;
}
...
.product--detail-wrapper .product__page .btn_cart, .product--detail-wrapper .product__page .product_count_wrapper {
    bottom: 10px;
}
...
.product--carousel-wrapper, .product--detail-info .product--gallery-wrapper {
    -ms-flex: 1 auto;
    flex: 1 auto;
    -webkit-flex: 1 auto;
}
